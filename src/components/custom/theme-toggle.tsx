  ...
  return (
    <CustomTooltip text={theme === 'dark' ? 'Switch to light' : 'Switch to dark'} side="bottom">
      <button
        ...
        className="flex h-[38px] w-[38px] shrink-0 cursor-pointer items-center justify-center rounded-full bg-gray-100 text-gray-700 transition-all hover:bg-ucass-primary-200 hover:text-foreground"
      >
