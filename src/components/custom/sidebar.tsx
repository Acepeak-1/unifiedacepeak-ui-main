...
/* navList/navListBottom/NavItem live in their own module now — mixing a
   ...
   was tripping Fast Refresh here (Vite's react-refresh plugin requires a
   file to export components only), which forced a full reload of every
   page under this sidebar on nearly every edit anywhere in the app. */
export type { NavItem } from './sidebar-nav-list';
